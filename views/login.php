    ...
    <div class="card-body login-card-body">
      ...
      <form action="#" method="POST" id="fm-login">
        <div class="input-group mb-3">
          <input type="text" id="user" name="user" class="form-control" placeholder="Usuario" data-validetta="required" data-vd-message-error="No debe quedar vacío" autocomplete="off">
