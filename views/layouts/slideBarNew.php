 ...
 <!-- Notifications Dropdown Menu -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=base_url?>" class="brand-link">
      <img src="<?=base_url?>/assets/dist/img/cardoffice-logo.png"
           alt="AdminLTE Logo"
...
<!-- Elementos de menu-->
          ...
          <!-- Si el elemento menu tiene URL, se creará un elemento sin sub elementos -->
            <li class="nav-item">
              <a href="<?=$dato['url']?>" class="nav-link">
                <?=$dato['icon']?>
                <p>
                  <?=$dato['nombre']?>
          ...
          <?php else:?>
            ...
            <!-- Si el elemento menu NO tiene URL, se creará un arbol de elementos -->
...
-->
          ...
          <li class="nav-item">
                <a href="<?=base_url?>usuario/close" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cerrar Sesion</p>
                </a>
          </li>
